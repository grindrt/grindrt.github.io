...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.updateFeed = undefined;
	
	__webpack_require__(3);
	
	__webpack_require__(329);
	
	var _getArticlesRequest = __webpack_require__(331);
	
	var _getArticlesRequest2 = _interopRequireDefault(_getArticlesRequest);
	
	var _newsApiClient = __webpack_require__(332);
	
	var _newsApiClient2 = _interopRequireDefault(_newsApiClient);
	
	var _feedBuilder = __webpack_require__(339);
	
	var _stateStore = __webpack_require__(343);
	...
	var latestNewsReducer = function latestNewsReducer() {
	...
	var topNewsReducer = function topNewsReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	    var action = arguments[1];
	...
	var feedStore = (0, _stateStore.createStore)(feedReducer);
	
	var updateFeed = function updateFeed() {
	    var source = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "bbc-news";
	
	    var element = document.getElementById("main-content");
	
	    _newsApiClient2.default.GetArticles({ source: source, apiKey: "cbcde34889f4417b9dce339f88f24de8", sortBy: "top" }).then(function (data) {
	        return feedStore.dispatch({ type: "UPDATE_LATEST_NEWS", articles: data.articles });
	    }).catch(function (exception) {
	        console.error(exception);
	        element.appendChild((0, _feedBuilder.buildErrorMessage)());
	    });
	
	    var sidebar = document.getElementById("sidebar");
	
	    _newsApiClient2.default.GetArticles({ source: source, apiKey: "cbcde34889f4417b9dce339f88f24de8", sortBy: "top" }).then(function (data) {
	        return feedStore.dispatch({ type: "UPDATE_TOP_NEWS", articles: data.articles });
	    }).catch(function (exception) {
	        console.error(exception);
	        sidebar.appendChild((0, _feedBuilder.buildErrorMessage)());
	    });
	};
	...
	var renderFeed = function renderFeed() {
	    ...
	    if (state.latestNews !== undefined) {
	        ...
	        mainContentElement.appendChild((0, _feedBuilder.buildNewsFeed)(state.latestNews));
	    }
	
	    if (state.topNews !== undefined) {
	        var sidebarElement = document.getElementById("sidebar");
	        var topNewsElement = document.getElementById("top-news");
	
	        if (topNewsElement !== null) {
	            sidebarElement.removeChild(topNewsElement);
	        }
	        sidebarElement.appendChild((0, _feedBuilder.buildPopularList)(state.topNews));
	    }
	};
...
/***/ (function(module, exports) {
	...
	var GetArticlesRequest = function GetArticlesRequest(_ref) {
	    var source = _ref.source,
	        apiKey = _ref.apiKey,
	        _ref$sortBy = _ref.sortBy,
	        sortBy = _ref$sortBy === undefined ? "top" : _ref$sortBy;
	
	    _classCallCheck(this, GetArticlesRequest);
	...
	exports.default = GetArticlesRequest;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fetchProxy = __webpack_require__(333);
	
	var _fetchProxy2 = _interopRequireDefault(_fetchProxy);
	
	var _getArticlesResponse = __webpack_require__(334);
	
	var _getArticlesResponse2 = _interopRequireDefault(_getArticlesResponse);
	
	var _getSourcesResponse = __webpack_require__(336);
	
	var _getSourcesResponse2 = _interopRequireDefault(_getSourcesResponse);
	...
	var NewsApiClient = function () {
	    ...
	    _createClass(NewsApiClient, null, [{
	        key: "GetArticles",
	        value: function GetArticles(request) {
	            var url = "https://newsapi.org/v1/articles?source=" + request.source + "&apiKey=" + request.apiKey + "&sortBy=" + request.sortBy;
	
	            return new Promise(function (resolve, reject) {
	                _fetchProxy2.default.fetch(url).then(function (data) {
	                    return resolve(new _getArticlesResponse2.default(data));
	                }).catch(function (exception) {
	        ...
	        key: "GetSources",
	        value: function GetSources(request) {
	            var url = "https://newsapi.org/v1/sources?category=" + request.category + "&language=" + request.language + "&country={request.country}";
	
	            return new Promise(function (resolve, reject) {
	                _fetchProxy2.default.fetch(url).then(function (data) {
	                    return resolve(new _getSourcesResponse2.default(data));
	                }).catch(function (exception) {
	                    return reject(exception);
	                });
	            });
...
/***/ (function(module, exports) {
	...
	var FetchProxy = function () {
	    function FetchProxy() {
	        _classCallCheck(this, FetchProxy);
	    }
	
	    _createClass(FetchProxy, null, [{
	        key: "fetch",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GetArticlesResponse = function GetArticlesResponse(_ref) {
	    ...
	    _classCallCheck(this, GetArticlesResponse);
	
	    this.status = status;
	    this.source = source;
	    this.sortBy = sortBy;
	    this.articles = Array.from(articles, function (article) {
	        return new _article2.default(article);
	    });
	};
	
	exports.default = GetArticlesResponse;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GetSourcesResponse = function GetSourcesResponse(_ref) {
	    var status = _ref.status,
	        _ref$sources = _ref.sources,
	        sources = _ref$sources === undefined ? [] : _ref$sources;
	
	    _classCallCheck(this, GetSourcesResponse);
	
	    this.status = status;
	    this.sources = Array.from(sources, function (source) {
	        return new _source2.default(source);
	    });
	};
	
	exports.default = GetSourcesResponse;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _urlsToLogos = __webpack_require__(338);
	
	var _urlsToLogos2 = _interopRequireDefault(_urlsToLogos);
	...
	var Source = function Source(_ref) {
	    var id = _ref.id,
	        ...
	        urlToLogos = _ref.urlToLogos,
	        _ref$sortBysAvailable = _ref.sortBysAvailable,
	        sortBysAvailable = _ref$sortBysAvailable === undefined ? [] : _ref$sortBysAvailable;
	    ...
	    this.urlToLogos = new _urlsToLogos2.default(urlToLogos.small, urlToLogos.medium, urlToLogos.large);
...
/***/ (function(module, exports) {
	...
	var UrlsToLogos = function UrlsToLogos(_ref) {
	    var small = _ref.small,
	        medium = _ref.medium,
	        large = _ref.large;
	
	    _classCallCheck(this, UrlsToLogos);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.buildPopularList = exports.buildNewsFeed = exports.buildErrorMessage = undefined;
	
	var _compositeElement = __webpack_require__(340);
	
	var _compositeElement2 = _interopRequireDefault(_compositeElement);
	
	var _textElement = __webpack_require__(342);
	...
	var buildErrorMessage = function buildErrorMessage() {
	    var header = new _compositeElement2.default("h2", { class: "error" });
	    header.add(new _textElement2.default("Error during fetch"));
	
	    var container = new _compositeElement2.default("div", { class: "container" });
	...
	var buildNewsFeed = function buildNewsFeed(articles) {
	    var buildHeader = function buildHeader(article) {
	        ...
	        var container = new _compositeElement2.default("header", { class: "article-heading" });
	        container.add(header);
	
	        return container;
	    };
	
	    var buildDescription = function buildDescription(article) {
	        var descriptionContainer = new _compositeElement2.default("div", { class: "article-description" });
	        descriptionContainer.add(new _textElement2.default(article.description));
	
	        return descriptionContainer;
	    };
	
	    var buildImg = function buildImg(article) {
	        var imageContainer = new _compositeElement2.default("div", { class: "article-image" });
	        imageContainer.add(new _compositeElement2.default("img", { src: article.urlToImage, alt: article.urlToImage }));
	
	        return imageContainer;
	    };
	
	    var buildFooter = function buildFooter(article) {
	        var author = new _compositeElement2.default("address", { class: "article-author" });
	        author.add(new _textElement2.default(article.author === null ? "" : article.author));
	
	        var publishedAt = new _compositeElement2.default("p", { class: "article-date" });
	        publishedAt.add(new _textElement2.default(article.publishedAt === null ? "" : article.publishedAt.toLocaleString()));
	
	        var container = new _compositeElement2.default("footer", { class: "article-footer" });
	    ...
	    var nodes = Array.from(articles, function (article) {
	        var container = new _compositeElement2.default("article", { class: "article" });
	    ...
	    var container = new _compositeElement2.default("div", { class: "container", id: "latest-news" });
	...
	var buildPopularList = function buildPopularList(articles) {
	    var buildHeader = function buildHeader(article) {
	        var link = new _compositeElement2.default("a", { target: "_blank", href: article.url });
	        link.add(new _textElement2.default(article.title));
	    ...
	    var buildBody = function buildBody(article) {
	        var imageContainer = new _compositeElement2.default("div", { class: "article-image" });
	        imageContainer.add(new _compositeElement2.default("img", { src: article.urlToImage, alt: article.urlToImage }));
	
	        var container = new _compositeElement2.default("div", { class: "article-body" });
	    ...
	    var nodes = Array.from(articles, function (article) {
	        var container = new _compositeElement2.default("article", { class: "article-aside" });
	        container.add(buildHeader(article));
	    ...
	    var container = new _compositeElement2.default("div", { class: "container", id: "top-news" });
	    nodes.forEach(function (node) {
	        return container.add(node);
	    });
	...
	exports.buildNewsFeed = buildNewsFeed;
	exports.buildPopularList = buildPopularList;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _element = __webpack_require__(341);
	...
	var CompositeElement = function (_Element) {
	    _inherits(CompositeElement, _Element);
	
	    function CompositeElement(type, attributes) {
	        _classCallCheck(this, CompositeElement);
	
	        var _this = _possibleConstructorReturn(this, (CompositeElement.__proto__ || Object.getPrototypeOf(CompositeElement)).call(this, type, attributes));
	    ...
	    _createClass(CompositeElement, [{
	        key: "draw",
	        value: function draw() {
	            var element = _get(CompositeElement.prototype.__proto__ || Object.getPrototypeOf(CompositeElement.prototype), "draw", this).call(this);
	            this.elements.forEach(function (i) {
	                return element.appendChild(i.draw());
	            });
	        ...
	        value: function remove(component) {
	            var index = this.elements.indexOf(component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TextElement = function (_Element) {
	    ...
	    function TextElement(text) {
	        ...
	        var _this = _possibleConstructorReturn(this, (TextElement.__proto__ || Object.getPrototypeOf(TextElement)).call(this, "text"));
