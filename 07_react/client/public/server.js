...
var codes = __webpack_require__(71)
...
var manifest = JSON.parse(_fs2.default.readFileSync(_path2.default.resolve('./public/manifest.json'), 'utf8'));

app.use(_express2.default.static('oublic'));
...
function useColors() {
  ...
  // explicitly
  if ("boolean" !== 'undefined' && false.process && false.process.type === 'renderer') {
    return true;
  }
  ...
  return (typeof document !== 'undefined' && document.documentElement && document.documentElement.style && document.documentElement.style.WebkitAppearance) ||
    ...
    ("boolean" !== 'undefined' && false.console && (false.console.firebug || (false.console.exception && false.console.table))) ||
    // is firefox >= v31?
...
function finalhandler (req, res, options) {
  ...
  // get environment
  var env = opts.env || undefined || 'development'
